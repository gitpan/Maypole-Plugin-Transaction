# This Makefile is for the Maypole::Plugin::Transaction extension to perl.
#
...
#     NAME => q[Maypole::Plugin::Transaction]
#     PREREQ_PM => { Maypole=>q[2.0] }
#     VERSION_FROM => q[Transaction.pm]
...
NAME_SYM = Maypole_Plugin_Transaction
VERSION = 0.02
...
FULLEXT = Maypole/Plugin/Transaction
BASEEXT = Transaction
...
TO_INST_PM = Transaction.pm

PM_TO_BLIB = Transaction.pm \
	$(INST_LIB)/Maypole/Plugin/Transaction.pm
...
DISTNAME = Maypole-Plugin-Transaction
DISTVNAME = Maypole-Plugin-Transaction-0.02
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3pm --perm_rw=$(PERM_RW)\
	  Transaction.pm $(INST_MAN3DIR)/Maypole::Plugin::Transaction.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  $(INST_LIB)/Maypole/Plugin/Transaction.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Maypole-Plugin-Transaction' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.02' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: Transaction.pm' >> META.yml
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  Transaction.pm $(INST_LIB)/Maypole/Plugin/Transaction.pm 
	$(NOECHO) $(TOUCH) $@
